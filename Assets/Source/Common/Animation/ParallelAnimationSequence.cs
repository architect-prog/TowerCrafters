...
{
    public class ParallelAnimationSequence : IAnimationSequence
    {
        ...
        public ParallelAnimationSequence(MonoBehaviour owner)
        {
            this.owner = owner;
        }
        ...
        {
            var result = new ParallelAnimationSequence(sequenceOwner);
            return result;
        }
